...
Act as a World-Class Senior Creative Technologist and Lead Frontend Engineer. Build a cinematic landing page for the brand 'Monrion' with the purpose 'A simple HTML CSS JS Portfolio Website in Portuguese from Portugal in text writing to show case the work done.' Select Preset B - 'Midnight Luxe' for the aesthetic. The three key value propositions are 'Showcasing professional work', 'Clean and minimalist design', and 'Interactive user experience'. The primary Call to Action is 'Contact Us'. Implement the provided Logo on both the Header and Footer. Ensure all technical requirements, component architectures, and build sequences are followed precisely, including GSAP animations, Tailwind CSS, and responsive design. Use real Unsplash URLs for images matching the 'dark marble, gold accents, architectural shadows, luxury interiors' mood.